      ...
      <div className={roboto.className}>
        ...
        <section className="mt-3">
          ...
          <article className="mb-3">
            ...
            <p className="text-base text-zinc-700">
              ...
              tracking and managing materials (including stock-in and
              stock-out), products, sales channels, transactions, and revenue
              statistics.
            </p>
          ...
          <article className="mb-6">
            ...
            <p className="text-base text-zinc-700">
              I used my experience in transportation and programming in this
              app. It shows how moving affects commute time and free time. The
              app uses real commuting times based on Google API.
            </p>
            <ul className="ml-8 list-disc text-base text-zinc-700">
          ...
          <article className="mb-6">
            ...
            <p className="text-base text-zinc-700">
              ...
              movies, games, and books. I worked with the project lead to
              program scripts for the backend and frontend of the app.
            </p>
            <ul className="ml-8 list-disc text-base text-zinc-700">
        ...
        <section className="mt-3">
          ...
          <article className="mb-3">
            ...
            <p className="text-base text-zinc-700 font-semibold">IDSK</p>
            <p className="text-base text-zinc-700">
              Team coordination, working with specialized software, and
              analytics
            </p>
          </article>
