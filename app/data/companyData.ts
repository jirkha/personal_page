...
export const companyData: { [key: string]: CompanyData } = {
  ...
  deloitte: {
    ...
    logo: "deloitte.svg",
    companyLink:
      "https://www.jsmedeloitte.cz/pozice/produktovy-specialista-do-tymu-tax-technology/",
    bgColor:
      "radial-gradient(circle, rgb(134, 188, 37, 0.3), rgb(134, 188, 37, 0.7)",
    textColor: "rgb(134, 188, 37)",
    imgClass: "mx-auto lg:mx-0 lg:-mt-20 lg:ml-auto w-1/2 sm:w-1/3 md:w-1/3",
    about:
      "Dosud jsem byl dopravním specialistou. Od roku 2021 se intenzivně věnuji rozvoji ve světě IT a programování. Vytvářím vlastní projekty a v oboru se dále vzdělávám. Nyní hledám pracovní příležitost v ",
    techStack: {
      backend: ["Python, PostgreSQL, Django, REST API"],
